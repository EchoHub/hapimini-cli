    ...
    common: {
        ...
        dev: {
            jsonDirs: [
                ...
                {
                    src: path.resolve(sl_srcPath, "components/**/*.json"),
                    dest: path.join(destPath, "components"),
                }
            ],
            axmlDirs: [
                ...
                {
                    src: path.resolve(sl_srcPath, "components/**/*.axml"),
                    dest: path.join(destPath, "components"),
                }
            ],
            lessDirs: [
                ...
                {
                    src: path.resolve(sl_srcPath, "components/**/*.acss"),
                    dest: path.join(destPath, "components"),
                },
                {
                    src: path.resolve(srcPath, "assets/styles/**/*.less"),
            ...
            jsDirs: [
                ...
                {
                    src: path.resolve(sl_srcPath, "components/**/*.js"),
                    dest: path.join(destPath, "components")
                }
            ]
        },
